...
| calc-level THz, 147²/150²/300², $n_b=2$, pure gauge, coherent, sheet | x14 README §7.3 | $T$: 1.000 (1 kV/cm) → 0.99 (30) → 0.987 (100, K averaged; 0.956 on 150², 300² pending) — induced *absorption* of 1–4 % at 100 kV/cm from the Landau–Zener pairs ($\sim4$–$11\times10^{11}$ cm⁻² after the pulse vs $1.5\times10^{12}$ per passage from Eq. 8); reflection $\le0.7$ %; the pair Drude weight screens $A_{\rm tot}$ by 4–6 %; ledger = fluence deficit to 3 digits; sheet passive after the pulse |
...
| near-IR πα, ring with $T_e$ | x14 README §7.5–7.6 | NIRRING_WIKI |
