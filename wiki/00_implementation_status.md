...
| `test_material_registry.f90` | material registry | GaAs/Si/Si_cb constants (dielectric, II fit, e-ph table), unknown→not-found, diamond flag, polar-LO weight convention |
