...
1. **graphene dissipators** — add the `epm_material='graphene'` registry entry (E2g 196 meV, A1′ 160 meV, gapless carrier-multiplication Auger, no-Kuhn-Zurek assertion). NOTE this is **gapless physics**, not just new constants: the gap-based II threshold and the recombination-Auger don't apply as-is — needs gapless-aware channel logic. (folded-era item 3.)
