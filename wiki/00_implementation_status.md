...
| `test_material_registry.f90` | material registry + provenance gates | GaAs/Si all gates `.true.`; CdS gates (e-ph/Coulomb/II/e-e `.true.`, II prefactor sentinel); unknown→not-found |
