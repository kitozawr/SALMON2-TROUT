...
1. **graphene dissipators (e-ph)** — add the `epm_material='graphene'` registry entry (E2g 196 meV, A1′ 160 meV; no-Kuhn-Zurek assertion). NOTE **gapless physics**: the gap-based II threshold doesn't apply as-is. (The graphene Auger/gapless-CM part is folded into the nonlocal-Auger task below, via the 2D Rana branch.)
