...
2. **Fortran EPM for CdS/graphene** (TODO-2) — extend the in-SALMON `src/epm` solver to the non-cubic primitive cells (no folding); Python refs are the source of truth meanwhile.
