...
| `yn_sbe_bgr_threshold` | — | `'n'` | `'y'`: density-dependent **band-gap-renormalized** II threshold $E_{\rm th}(t)=E_{\rm th0}-\lvert Kn^{1/3}\rvert$ (needs impact ionization on). |
